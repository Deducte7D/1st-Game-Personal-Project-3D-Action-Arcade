...
public class KeeperController : MonoBehaviour
{
    ...
    public void ResetKeeperBool()
    {
        ...
        isAttachedSnap = true;
        boolIntercepted = false;
        isDebugged = false;
        isDebugged2 = false;
        canInitiateCI = true;
        applyRunTowardsBall = true;

    }

    public void ResetKeeperAnimation()
    {

        // position no need to preset since spawn point already done
        //KeeperAnim.SetBool("Reset2_bool", true);
        //KeeperAnim.Play("Idle", -1, 0f);
        KeeperAnim.Rebind();
